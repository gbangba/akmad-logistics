...
<section className="py-16 px-6 bg-white">
  ...
  {result && (
    <div className="mt-6 bg-gray-100 p-4 rounded shadow max-w-xl mx-auto text-center">
      <p><strong>Status:</strong> {result.status}</p>
      <p><strong>Recipient:</strong> {result.recipient}</p>
      <p><strong>From:</strong> {result.origin}</p>
      <p><strong>To:</strong> {result.destination}</p>
      <p><strong>Last Updated:</strong> {new Date(result.updated_at).toLocaleString()}</p>
    </div>
  )}
</section>
